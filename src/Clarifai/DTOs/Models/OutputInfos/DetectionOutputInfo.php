...
class DetectionOutputInfo implements OutputInfoInterface
{
     ...
     */
    public function __construct($type, $typeExt, $message, $concepts, $areConceptsMutuallyExclusive,
        $isEnvironmentClosed, $language)
    {
        $this->type = $type;
