...
class ConfusionMatrix extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>repeated .clarifai.api.ConfusionMatrixEntry matrix = 1;</code>
     * @param \Clarifai\Grpc\ConfusionMatrixEntry[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMatrix($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Clarifai\Grpc\ConfusionMatrixEntry::class);
        $this->matrix = $arr;
