...
class CooccurrenceMatrix extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>repeated .clarifai.api.CooccurrenceMatrixEntry matrix = 1;</code>
     * @param \Clarifai\Grpc\CooccurrenceMatrixEntry[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMatrix($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Clarifai\Grpc\CooccurrenceMatrixEntry::class);
        $this->matrix = $arr;
