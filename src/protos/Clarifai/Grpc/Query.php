...
class Query extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>repeated .clarifai.api.And ands = 1;</code>
     * @param \Clarifai\Grpc\PBAnd[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAnds($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Clarifai\Grpc\PBAnd::class);
        $this->ands = $arr;
