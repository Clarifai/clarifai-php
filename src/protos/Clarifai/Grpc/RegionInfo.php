...
class RegionInfo extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.clarifai.api.BoundingBox bounding_box = 1;</code>
     * @return \Clarifai\Grpc\BoundingBox
     */
    ...
    /**
     * Generated from protobuf field <code>.clarifai.api.BoundingBox bounding_box = 1;</code>
     * @param \Clarifai\Grpc\BoundingBox $var
     * @return $this
     */
    public function setBoundingBox($var)
    {
        GPBUtil::checkMessage($var, \Clarifai\Grpc\BoundingBox::class);
    ...
    {
        GPBUtil::checkEnum($var, \Clarifai\Grpc\RegionInfoFeedback::class);
        $this->feedback = $var;
    ...
    /**
     * Generated from protobuf field <code>.clarifai.api.Mask mask = 4;</code>
     * @param \Clarifai\Grpc\Mask $var
     * @return $this
     */
    public function setMask($var)
    {
        GPBUtil::checkMessage($var, \Clarifai\Grpc\Mask::class);
        $this->mask = $var;
