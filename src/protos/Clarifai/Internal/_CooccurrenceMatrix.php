 ...
 */
class _CooccurrenceMatrix extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>repeated .clarifai.api.CooccurrenceMatrixEntry matrix = 1;</code>
     * @param \Clarifai\Internal\_CooccurrenceMatrixEntry[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMatrix($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Clarifai\Internal\_CooccurrenceMatrixEntry::class);
        $this->matrix = $arr;
